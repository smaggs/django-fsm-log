...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StateLog.reason'
        db.add_column(u'django_fsm_log_statelog', 'reason',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StateLog.reason'
        db.delete_column(u'django_fsm_log_statelog', 'reason')
